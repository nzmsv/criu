...
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_SUSPEND_IBDEV, rdma_mlx5_vfmig_plugin_suspend_ibdev)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_DUMP_UVERBS_CONTEXT, rdma_mlx5_vfmig_plugin_dump_uverbs_context)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_DUMP_UOBJ_PD, rdma_mlx5_vfmig_plugin_dump_uobj_pd)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_DUMP_UOBJ_CQ, rdma_mlx5_vfmig_plugin_dump_uobj_cq)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_DUMP_UOBJ_QP, rdma_mlx5_vfmig_plugin_dump_uobj_qp)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_RESTORE_UOBJ_PD_UHW_PACK, rdma_mlx5_vfmig_plugin_restore_uobj_pd_uhw_pack)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_RESTORE_UOBJ_MR_UHW_PACK, rdma_mlx5_vfmig_plugin_restore_uobj_mr_uhw_pack)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_RESTORE_UOBJ_CQ_UHW_PACK, rdma_mlx5_vfmig_plugin_restore_uobj_cq_uhw_pack)
CR_PLUGIN_REGISTER_HOOK(CR_PLUGIN_HOOK__RDMA_RESTORE_UOBJ_QP_UHW_PACK, rdma_mlx5_vfmig_plugin_restore_uobj_qp_uhw_pack)
